...
function derivativeIntervalSign(a, b, left, right) {
...
const turningValuesCache = new Map();

function turningValues(a, b) {
    const key = `${a},${b}`;
